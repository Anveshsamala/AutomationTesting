...
{
		String url=ExcelOperatio.readdata("Sheet1",1,0);
		String browser=ExcelOperatio.readdata("Sheet1", 1, 3);
...
{
		String un=ExcelOperatio.readdata("Sheet1", 1, 1);
		String psd=ExcelOperatio.readdata("Sheet1", 1, 2);
